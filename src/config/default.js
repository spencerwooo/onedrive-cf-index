...
const config = {
     ...
     */
    client_id: 'd4ef649e-d9a2-4ead-b7d3-b33a33d5fe31',
    ...
    pagination: {
      enable: true,
      top: 500 // default: 200, accepts a minimum value of 1 and a maximum value of 999 (inclusive)
    },
  ...
  !(function ({
    ...
    config.apiEndpoint = {
      ...
      auth: accountType ?
        'https://login.chinacloudapi.cn/common/oauth2/v2.0' : 'https://login.microsoftonline.com/common/oauth2/v2.0'
    }
